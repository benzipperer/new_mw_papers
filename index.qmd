...
This page displays a list of recent papers on minimum wages, sourced from [OpenAlex](https://openalex.org/) over the last 12 months. The data is updated daily.
